...
def global_from_monthly_cdm(dir_data, cdm_id = None, region = 'Global', 
    ...
    header_df = dd.read_csv(header_path,delimiter = DELIMITER,usecols = READ_COLS_HDR,parse_dates=['report_timestamp'],dtype = DTYPES_HDR)
    ...
    for table in obs_tables:
        ...
        obs_df = dd.read_csv(table_path,delimiter = DELIMITER,usecols = READ_COLS,parse_dates=['date_time'],dtype = DTYPES)
